...
public class RetailAccountSteps extends CommonUtility {
	...
	public void userFillNewAddressFormWithBelowInformation(DataTable dataTable) {
		...
		selectByVisibleText(factory.accountPage().countryDropDownAddress, addAddress.get(0).get("country"));
		sendText(factory.accountPage().fullNameInputAddress, addAddress.get(0).get("fullName"));
		sendText(factory.accountPage().phoneNumberAddress, addAddress.get(0).get("phoneNumber"));
		sendText(factory.accountPage().streetInputAddress, addAddress.get(0).get("apt"));
		sendText(factory.accountPage().cityAddress, addAddress.get(0).get("city"));
		selectByVisibleText(factory.accountPage().stateAddress, addAddress.get(0).get("state"));
	...
	public void addressDetailsShouldBeRemoved() {
		...
		//Assert.assertTrue(isElementNotDisplayed(factory.accountPage().removeAddress));
